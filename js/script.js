...
$(function() {
  ...
  //ハンバーガーメニュー2------------------------------------------
 $(".drawer-icon").on('click', function(e) {     //is-activeクラスをつけて表示切り替え
     e.preventDefault();
 ...
 $(".drawer-background").on('click', function(e) {    //背景をクリックして戻す
     e.preventDefault();
 ...
 $(".drawer-content__item a").on('click', function( ) {     //ドロワーメニュータグを押したら戻す
     $(".drawer-icon" ).toggleClass("is-active");
     $(".drawer-content" ).toggleClass("is-active");
     $(".drawer-background" ).toggleClass("is-active");
  ...
  $('.qr-container__q').click( function() {
    $(this).next().slideToggle();
    $(this).children(".qr-container__icon").toggleClass("is-open");
  });
 ...
 // べージトップボタン=========================
  ...
  // ウインドウをスクロールしてイベント発火
  // ウインドウを500 TopからスクロールしたらslideDownで表示。0.3秒で
...
$("a[href^='#']").click(function(){
  ...
  $(".tab-navigation__item a").click(function ( ) {
    $(".tab-navigation__item a").removeClass("is-active");
    $(this).addClass("is-active");
